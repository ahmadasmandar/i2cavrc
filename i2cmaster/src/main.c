...
// #define Dev24C02 16 // device address of EEPROM 24C02, see datasheet
...
//         i2c_stop();
//         printString("Failed to send data");
//         PORTB = 0x00; // activate all 8 LED to show error */
//     }
//     else
//     {
//         printString("connection success and we sent data packet...");
...
//         printString("request was sent  .. ");
//         i2c_write(0x05); // write address = 5
//         _delay_ms(60);
//         printString("read adress was  sent  .. ");
//         i2c_rep_start(Dev24C02 + I2C_READ); // set device address and read mode
//         _delay_ms(60);
//         printString("i2c_rep_start wait to read...  .. ");
//         ret = i2c_readNak(); // read one byte
//         _delay_ms(60);
//         printString("read success ...  .. ");
//         i2c_stop();
//         printByte(ret);
